...
@Service
public class CancelApplicationForJobVacancyUseCase {
    @Autowired
    ...
    public void perform(String tokenSession, UUID vacancyId){
        ...
        existVacancy.get().getUsers().remove(user);

        this.vacanciesRepository.save(existVacancy.get());
    }
